...
import com.codenvy.ide.ext.java.jdt.core.formatter.align.AlignmentException;
...
public class CodeFormatterVisitor extends ASTVisitor {
    ...
    */
    private static final int[] SINGLETYPEREFERENCE_EXPECTEDTOKENS = new int[]{TerminalTokens.TokenNameIdentifier,
                                                                              TerminalTokens.TokenNameboolean, TerminalTokens.TokenNamebyte,
                                                                              TerminalTokens.TokenNamechar,
                                                                              TerminalTokens.TokenNamedouble, TerminalTokens.TokenNamefloat,
                                                                              TerminalTokens.TokenNameint,
                                                                              TerminalTokens.TokenNamelong, TerminalTokens.TokenNameshort,
                                                                              TerminalTokens.TokenNamevoid};

    private static final int[] CLOSING_GENERICS_EXPECTEDTOKENS = new int[]{TerminalTokens.TokenNameRIGHT_SHIFT,
    ...
    public CodeFormatterVisitor(DefaultCodeFormatterOptions preferences, Map settings, Region[] regions,
            ...
            if (currentNode instanceof FieldDeclaration) {
                ...
                if (mergedNodes.size() == 0) {
                    ...
                    if (previousMergedNode instanceof MultiFieldDeclaration) {
                        ...
                        System.arraycopy(multiFieldDeclaration.declarations, 0, multiFieldDeclaration.declarations =
                                new FieldDeclaration[length + 1], 0, length);
                        ...
                        if (currentField.declarationSourceStart == previousFieldDeclaration.declarationSourceStart) {
                            ...
                            final MultiFieldDeclaration multiFieldDeclaration =
                                    new MultiFieldDeclaration(new FieldDeclaration[]{previousFieldDeclaration, currentField});
                ...
                if (fieldStart < methodStart && fieldStart < typeStart) {
                    ...
                    if (fieldStart == previousFieldStart) {
                        ...
                        if (previousMember instanceof MultiFieldDeclaration) {
                            ...
                            System.arraycopy(multiField.declarations, 0, multiField.declarations =
                                    new FieldDeclaration[length + 1], 0, length);
                            multiField.declarations[length] = field;
                        } else {
                            FieldDeclaration fieldDeclaration = (FieldDeclaration)previousMember;
                            final MultiFieldDeclaration multiFieldDeclaration =
                                    new MultiFieldDeclaration(new FieldDeclaration[]{fieldDeclaration, field});
    ...
    private boolean dumpBinaryExpression(BinaryExpression binaryExpression, int operator, BlockScope scope) {
        ...
        try {
            ...
            if ((builder.realFragmentsSize() > 1 || fragmentsSize > 4) && numberOfParens == 0) {
                ...
                Alignment binaryExpressionAlignment =
                        this.scribe.createAlignment(Alignment.BINARY_EXPRESSION,
                                                    this.preferences.alignment_for_binary_expression, Alignment.R_OUTERMOST, fragmentsSize,
    ...
    private boolean dumpEqualityExpression(BinaryExpression binaryExpression, int operator, BlockScope scope) {
        ...
        try {
            ...
            binaryExpression.left.traverse(this, scope);
            this.scribe.printNextToken(operator, this.preferences.insert_space_before_binary_operator,
                                       Scribe.PRESERVE_EMPTY_LINES_IN_EQUALITY_EXPRESSION);
            if (this.preferences.insert_space_after_binary_operator) {
                this.scribe.space();
            }
            binaryExpression.right.traverse(this, scope);
    ...
    private void format(AbstractMethodDeclaration methodDeclaration, ClassScope scope, boolean isChunkStart,
      ...
      /* Field initialization */
        ...
        if (initialization != null) {
            ...
            Alignment assignmentAlignment =
                    this.scribe
                            .createAlignment(Alignment.FIELD_DECLARATION_ASSIGNMENT, this.preferences.alignment_for_assignment,
                                             Alignment.R_INNERMOST, 1, this.scribe.scanner.currentPosition);
    ...
    private void format(ImportReference importRef, boolean isLast) {
        ...
        if (!isLast)
            this.scribe.blank_lines_between_import_groups = this.preferences.blank_lines_between_import_groups;
        this.scribe.space();
    ...
    private void format(MultiFieldDeclaration multiFieldDeclaration, ASTVisitor visitor, MethodScope scope,
        ...
        Alignment multiFieldDeclarationsAlignment =
                this.scribe.createAlignment(Alignment.MULTIPLE_FIELD, this.preferences.alignment_for_multiple_fields,
                                            multipleFieldDeclarationsLength - 1, this.scribe.scanner.currentPosition);
               ...
               /* Field initialization */
                    ...
                    if (i != length - 1) {
                        this.scribe.printNextToken(TerminalTokens.TokenNameCOMMA,
                                                   this.preferences.insert_space_before_comma_in_multiple_field_declarations);
                        this.scribe.printComment(CodeFormatter.K_UNKNOWN, Scribe.BASIC_TRAILING_COMMENT);
    ...
    private void format(TypeDeclaration typeDeclaration) {
      ...
      /* Type name */
        switch (TypeDeclaration.kind(typeDeclaration.modifiers)) {
            ...
            case TypeDeclaration.ANNOTATION_TYPE_DECL:
                this.scribe.printNextToken(TerminalTokens.TokenNameAT,
                                           this.preferences.insert_space_before_at_in_annotation_type_declaration);
                this.scribe.printNextToken(TerminalTokens.TokenNameinterface,
                                           this.preferences.insert_space_after_at_in_annotation_type_declaration);
                break;
        }
        this.scribe.printNextToken(TerminalTokens.TokenNameIdentifier, true);
        ...
        if (typeParameters != null) {
            this.scribe.printNextToken(TerminalTokens.TokenNameLESS,
                                       this.preferences.insert_space_before_opening_angle_bracket_in_type_parameters);
            ...
            for (int i = 0; i < length - 1; i++) {
                ...
                this.scribe.printNextToken(TerminalTokens.TokenNameCOMMA,
                                           this.preferences.insert_space_before_comma_in_type_parameters);
            ...
            if (isClosingGenericToken()) {
                this.scribe.printNextToken(CLOSING_GENERICS_EXPECTEDTOKENS,
                                           this.preferences.insert_space_before_closing_angle_bracket_in_type_parameters);
            }
      ...
      /* Superclass */
        ...
        if (superclass != null) {
            Alignment superclassAlignment =
                    this.scribe.createAlignment(Alignment.SUPER_CLASS,
                                                this.preferences.alignment_for_superclass_in_type_declaration, 2,
                                                this.scribe.scanner.currentPosition);
            ...
            do {
                try {
                    ...
                    for (int i = 0; i < superInterfaceLength; i++) {
                        if (i > 0) {
                            this.scribe.printNextToken(TerminalTokens.TokenNameCOMMA,
                                                       this.preferences.insert_space_before_comma_in_superinterfaces);
                            this.scribe.printComment(CodeFormatter.K_UNKNOWN, Scribe.BASIC_TRAILING_COMMENT);
      ...
      /* Type body */
        ...
        switch (kind) {
            ...
            case TypeDeclaration.ANNOTATION_TYPE_DECL:
                ...
                space_before_opening_brace =
                        this.preferences.insert_space_before_opening_brace_in_annotation_type_declaration;
                break;
            default:
        ...
        switch (kind) {
            case TypeDeclaration.ENUM_DECL:
                indent_body_declarations_compare_to_header =
                        this.preferences.indent_body_declarations_compare_to_enum_declaration_header;
                break;
            case TypeDeclaration.ANNOTATION_TYPE_DECL:
                indent_body_declarations_compare_to_header =
                        this.preferences.indent_body_declarations_compare_to_annotation_declaration_header;
                break;
            default:
                indent_body_declarations_compare_to_header =
                        this.preferences.indent_body_declarations_compare_to_type_header;
                break;
        }
        ...
        if (kind == TypeDeclaration.ENUM_DECL) {
                ...
                if (enumConstantsLength > 1) {
                    Alignment enumConstantsAlignment =
                            this.scribe.createAlignment(Alignment.ENUM_CONSTANTS, this.preferences.alignment_for_enum_constants,
                                                        enumConstantsLength, this.scribe.scanner.currentPosition, 0,
                                                        // we don't want to indent enum constants when
                        ...
                        try {
                            for (int i = 0; i < enumConstantsLength; i++) {
                                ...
                                if (isNextToken(TerminalTokens.TokenNameCOMMA)) {
                                    this.scribe.printNextToken(TerminalTokens.TokenNameCOMMA,
                                                               this.preferences.insert_space_before_comma_in_enum_declarations);
            ...
            if (isNextToken(TerminalTokens.TokenNameSEMICOLON)) {
                this.scribe.printNextToken(TerminalTokens.TokenNameSEMICOLON,
                                           this.preferences.insert_space_before_semicolon);
                this.scribe.printComment(CodeFormatter.K_UNKNOWN, Scribe.BASIC_TRAILING_COMMENT);
                if (hasConstants || ((enumConstantsLength - length) != 0) || typeDeclaration.methods != null
    ...
    private void format(TypeDeclaration memberTypeDeclaration, ClassScope scope, boolean isChunkStart,
                        boolean isFirstClassBodyDeclaration) {
    ...
    private void formatAnonymousTypeDeclaration(TypeDeclaration typeDeclaration) {
      /* Type body */
        ...
        formatTypeOpeningBrace(anonymous_type_declaration_brace_position,
                               this.preferences.insert_space_before_opening_brace_in_anonymous_type_declaration, typeDeclaration);
     ...
     */
    private void formatBlock(Block block, BlockScope scope, String block_brace_position,
    ...
    private void formatCascadingMessageSends(CascadingMethodInvocationFragmentBuilder builder, BlockScope scope) {
        ...
        if (!fragment.isImplicitThis()) {
            ...
            if (arguments != null) {
                ...
                Alignment argumentsAlignment =
                        this.scribe.createAlignment(Alignment.MESSAGE_ARGUMENTS,
                                                    this.preferences.alignment_for_arguments_in_method_invocation, Alignment.R_OUTERMOST,
                                                    argumentLength,
                                                    this.scribe.scanner.currentPosition);
                ...
                do {
                    try {
                        for (int j = 0; j < argumentLength; j++) {
                            if (j > 0) {
                                this.scribe.printNextToken(TerminalTokens.TokenNameCOMMA,
                                                           this.preferences.insert_space_before_comma_in_method_invocation_arguments);
                                this.scribe.printComment(CodeFormatter.K_UNKNOWN, Scribe.BASIC_TRAILING_COMMENT);
                            }
        ...
        int tieBreakRule =
                this.preferences.wrap_outer_expressions_when_nested && size - startingPositionInCascade > 2
                ? Alignment.R_OUTERMOST : Alignment.R_INNERMOST;
        Alignment cascadingMessageSendAlignment =
                this.scribe.createAlignment(Alignment.CASCADING_MESSAGE_SEND,
                                            this.preferences.alignment_for_selector_in_method_invocation, tieBreakRule, size,
                                            this.scribe.scanner.currentPosition);
        ...
        do {
            ...
            try {
                ...
                for (int i = startingPositionInCascade; i < size; i++) {
                    ...
                    final int numberOfParens =
                            (currentMessageSend.bits & ASTNode.ParenthesizedMASK) >> ASTNode.ParenthesizedSHIFT;
                    if (numberOfParens > 0) {
                        manageOpeningParenthesizedExpression(currentMessageSend, numberOfParens);
                    }
                    TypeReference[] typeArguments = currentMessageSend.typeArguments;
                    ...
                    if (arguments != null) {
                        ...
                        Alignment argumentsAlignment =
                                this.scribe.createAlignment(Alignment.MESSAGE_ARGUMENTS, alignmentMode, Alignment.R_OUTERMOST,
                                                            argumentLength, this.scribe.scanner.currentPosition);
                        this.scribe.enterAlignment(argumentsAlignment);
                        boolean okForArguments = false;
                        do {
    ...
    private void formatClassBodyDeclarations(ASTNode[] nodes) {
        ...
        Alignment memberAlignment =
                this.scribe.createMemberAlignment(Alignment.TYPE_MEMBERS, this.preferences.align_type_members_on_columns
                                                                          ? Alignment.M_MULTICOLUMN : Alignment.M_NO_ALIGNMENT, 4,
                                                  this.scribe.scanner.currentPosition);
                        ...
                        if (member instanceof MultiFieldDeclaration) {
                            ...
                            if (newLineBeforeChunk > 0 && i != 0) {
                                ...
                                int newLinesBeforeFirstClassBodyDeclaration =
                                        this.preferences.blank_lines_before_first_class_body_declaration;
                                if (newLinesBeforeFirstClassBodyDeclaration > 0) {
                                    this.scribe.printEmptyLines(newLinesBeforeFirstClassBodyDeclaration);
                                }
                            }
    ...
    private void formatGuardClauseBlock(Block block, BlockScope scope) {
        ...
        this.scribe.printNextToken(TerminalTokens.TokenNameLBRACE,
    ...
    private void formatLocalDeclaration(LocalDeclaration localDeclaration, BlockScope scope,
        ...
        if (!isMultipleLocalDeclaration(localDeclaration)) {
            if (localDeclaration.modifiers != NO_MODIFIERS || localDeclaration.annotations != null) {
                ...
                this.scribe.printModifiers(localDeclaration.annotations, this,
                                           ICodeFormatterConstants.ANNOTATION_ON_LOCAL_VARIABLE);
                this.scribe.space();
            }
      ...
      /* Check for extra dimensions */
        ...
        if (initialization != null) {
         /* Print the method name */
            ...
            Alignment assignmentAlignment =
                    this.scribe
                            .createAlignment(Alignment.LOCAL_DECLARATION_ASSIGNMENT, this.preferences.alignment_for_assignment,
                                             Alignment.R_OUTERMOST, 1, this.scribe.scanner.currentPosition);
            this.scribe.enterAlignment(assignmentAlignment);
            boolean ok = false;
            do {
                try {
    ...
    private void formatMessageSend(MessageSend messageSend, BlockScope scope, Alignment messageAlignment) {
        ...
        if (arguments != null) {
            ...
            if (argumentsLength > 1) {
                int alignmentMode = this.preferences.alignment_for_arguments_in_method_invocation;
                Alignment argumentsAlignment =
                        this.scribe.createAlignment(Alignment.MESSAGE_ARGUMENTS, alignmentMode, argumentsLength,
                                                    this.scribe.scanner.currentPosition);
                this.scribe.enterAlignment(argumentsAlignment);
                boolean ok = false;
                do {
    ...
    private void formatTryResources(TryStatement tryStatement, boolean spaceBeforeOpenParen,
                                    boolean spaceBeforeClosingParen, boolean spaceBeforeFirstResource, boolean spaceBeforeSemicolon,
                                    boolean spaceAfterSemicolon, int tryResourcesAligment) {
        ...
        if (length > 0) {
            ...
            Alignment resourcesAlignment = this.scribe.createAlignment(Alignment.TRY_RESOURCES, tryResourcesAligment,
                                                                       // make sure alignment options for try with resources takes
                                                                       // precedence
                                                                       Alignment.R_OUTERMOST, length, this.scribe.scanner.currentPosition);
    ...
    private void formatMethodArguments(AbstractMethodDeclaration methodDeclaration, boolean spaceBeforeOpenParen,
                                       boolean spaceBetweenEmptyParameters, boolean spaceBeforeClosingParen,
                                       boolean spaceBeforeFirstParameter,
                                       boolean spaceBeforeComma, boolean spaceAfterComma, int methodDeclarationParametersAlignment) {
        ...
        if (arguments != null) {
            ...
            int argumentLength = arguments.length;
            Alignment argumentsAlignment =
                    this.scribe.createAlignment(Alignment.METHOD_ARGUMENTS, methodDeclarationParametersAlignment,
                                                argumentLength, this.scribe.scanner.currentPosition);
            this.scribe.enterAlignment(argumentsAlignment);
            boolean ok = false;
            do {
    ...
    private void formatEnumConstantArguments(FieldDeclaration enumConstant, boolean spaceBeforeOpenParen,
                                             boolean spaceBetweenEmptyParameters, boolean spaceBeforeClosingParen,
                                             boolean spaceBeforeFirstParameter,
                                             boolean spaceBeforeComma, boolean spaceAfterComma, int methodDeclarationParametersAlignment) {
        ...
        if (arguments != null) {
            int argumentLength = arguments.length;
            Alignment argumentsAlignment =
                    this.scribe.createAlignment(Alignment.ENUM_CONSTANTS_ARGUMENTS, methodDeclarationParametersAlignment,
                                                argumentLength, this.scribe.scanner.currentPosition);
            this.scribe.enterAlignment(argumentsAlignment);
            boolean ok = false;
            do {
    ...
    private void formatThrowsClause(AbstractMethodDeclaration methodDeclaration, boolean spaceBeforeComma,
                                    boolean spaceAfterComma, int alignmentForThrowsClause) {
    ...
    private void formatTypeMembers(TypeDeclaration typeDeclaration) {
        Alignment memberAlignment =
                this.scribe.createMemberAlignment(Alignment.TYPE_MEMBERS, this.preferences.align_type_members_on_columns
                                                                          ? Alignment.M_MULTICOLUMN : Alignment.M_NO_ALIGNMENT, 3,
                                                  this.scribe.scanner.currentPosition);
        this.scribe.enterMemberAlignment(memberAlignment);
            ...
            do {
                try {
                    for (int i = startIndex, max = members.length; i < max; i++) {
                        ...
                        if (member instanceof FieldDeclaration) {
                            isChunkStart =
                                    memberAlignment.checkChunkStart(Alignment.CHUNK_FIELD, i, this.scribe.scanner.currentPosition);
                            if (member instanceof MultiFieldDeclaration) {
                                MultiFieldDeclaration multiField = (MultiFieldDeclaration)member;
                            ...
                            isChunkStart =
                                    memberAlignment.checkChunkStart(Alignment.CHUNK_METHOD, i, this.scribe.scanner.currentPosition);
                            format((AbstractMethodDeclaration)member, typeDeclaration.scope, isChunkStart, i == 0);
                        } else if (member instanceof TypeDeclaration) {
                            isChunkStart =
                                    memberAlignment.checkChunkStart(Alignment.CHUNK_TYPE, i, this.scribe.scanner.currentPosition);
    ...
    private void formatTypeOpeningBraceForEnumConstant(String bracePosition, boolean insertSpaceBeforeBrace,
    ...
    private boolean isGuardClause(Block block) {
        return !commentStartsBlock(block.sourceStart, block.sourceEnd) && block.statements != null
    ...
    private void manageClosingParenthesizedExpression(Expression expression, int numberOfParens) {
        for (int i = 0; i < numberOfParens; i++) {
            this.scribe.printNextToken(TerminalTokens.TokenNameRPAREN,
                                       this.preferences.insert_space_before_closing_paren_in_parenthesized_expression);
        }
    }
    ...
    private void manageOpeningParenthesizedExpression(Expression expression, int numberOfParens) {
        for (int i = 0; i < numberOfParens; i++) {
            this.scribe.printNextToken(TerminalTokens.TokenNameLPAREN,
                                       this.preferences.insert_space_before_opening_paren_in_parenthesized_expression);
    ...
    public boolean visit(AllocationExpression allocationExpression, BlockScope scope) {
        ...
        if (arguments != null) {
            ...
            int argumentLength = arguments.length;
            Alignment argumentsAlignment =
                    this.scribe.createAlignment(Alignment.ALLOCATION,
                                                this.preferences.alignment_for_arguments_in_allocation_expression, argumentLength,
                                                this.scribe.scanner.currentPosition);
            this.scribe.enterAlignment(argumentsAlignment);
            boolean ok = false;
            do {
      ...
      /* Argument type */
        if (argument.type != null) {
            if (argument.type instanceof UnionTypeReference) {
                formatMultiCatchArguments(argument, this.preferences.insert_space_before_binary_operator,
                                          this.preferences.insert_space_after_binary_operator,
                                          this.preferences.alignment_for_union_type_in_multicatch, scope);
            } else {
    ...
    public boolean visit(ArrayAllocationExpression arrayAllocationExpression, BlockScope scope) {
        ...
        final int numberOfParens =
                (arrayAllocationExpression.bits & ASTNode.ParenthesizedMASK) >> ASTNode.ParenthesizedSHIFT;
        if (numberOfParens > 0) {
        ...
        for (int i = 0; i < dimensionsLength; i++) {
            ...
            if (dimensions[i] != null) {
                ...
                this.scribe.printNextToken(TerminalTokens.TokenNameRBRACKET,
                                           this.preferences.insert_space_before_closing_bracket_in_array_allocation_expression);
            } else {
                this.scribe.printNextToken(TerminalTokens.TokenNameRBRACKET,
                                           this.preferences.insert_space_between_empty_brackets_in_array_allocation_expression);
            }
        }
        ...
        try {
            ...
            if (expressions != null) {
                ...
                formatOpeningBrace(array_initializer_brace_position,
                                   this.preferences.insert_space_before_opening_brace_in_array_initializer);

                int expressionsLength = expressions.length;
                final boolean insert_new_line_after_opening_brace =
                        this.preferences.insert_new_line_after_opening_brace_in_array_initializer;
                boolean ok = false;
                ...
                if (expressionsLength > 1) {
                    ...
                    arrayInitializerAlignment =
                            this.scribe.createAlignment(Alignment.ARRAY_INITIALIZER,
                                                        this.preferences.alignment_for_expressions_in_array_initializer,
                                                        Alignment.R_OUTERMOST,
                                                        expressionsLength, this.scribe.scanner.currentPosition,
                                                        this.preferences.continuation_indentation_for_array_initializer, true);
                    ...
                    do {
                        try {
                            ...
                            for (int i = 1; i < expressionsLength; i++) {
                                this.scribe.printNextToken(TerminalTokens.TokenNameCOMMA,
                                                           this.preferences.insert_space_before_comma_in_array_initializer);
                                this.scribe.printComment(CodeFormatter.K_UNKNOWN, Scribe.BASIC_TRAILING_COMMENT);
                    ...
                    if (this.scribe.currentAlignment == null
                        || this.scribe.currentAlignment.kind != Alignment.MESSAGE_ARGUMENTS) {
                        arrayInitializerAlignment =
                                this.scribe.createAlignment(Alignment.ARRAY_INITIALIZER,
                                                            this.preferences.alignment_for_expressions_in_array_initializer,
                                                            Alignment.R_OUTERMOST, 0,
                                                            this.scribe.scanner.currentPosition,
                                                            this.preferences.continuation_indentation_for_array_initializer, true);
                        this.scribe.enterAlignment(arrayInitializerAlignment);
                    }
                ...
                if (keepEmptyArrayInitializerOnTheSameLine) {
                    ...
                    this.scribe.printNextToken(TerminalTokens.TokenNameRBRACE,
                                               this.preferences.insert_space_between_empty_braces_in_array_initializer);
                } else {
                    formatOpeningBrace(array_initializer_brace_position,
                                       this.preferences.insert_space_before_opening_brace_in_array_initializer);
                    if (isNextToken(TerminalTokens.TokenNameCOMMA)) {
    ...
    public boolean visit(ArrayQualifiedTypeReference arrayQualifiedTypeReference, BlockScope scope) {
        ...
        final int numberOfParens =
                (arrayQualifiedTypeReference.bits & ASTNode.ParenthesizedMASK) >> ASTNode.ParenthesizedSHIFT;
        if (numberOfParens > 0) {
            manageOpeningParenthesizedExpression(arrayQualifiedTypeReference, numberOfParens);
        }
        this.scribe.printArrayQualifiedReference(arrayQualifiedTypeReference.tokens.length,
                                                 arrayQualifiedTypeReference.sourceEnd);
    ...
    public boolean visit(ArrayReference arrayReference, BlockScope scope) {
        ...
        this.scribe.printNextToken(TerminalTokens.TokenNameLBRACKET,
                                   this.preferences.insert_space_before_opening_bracket_in_array_reference);
        if (this.preferences.insert_space_after_opening_bracket_in_array_reference) {
            this.scribe.space();
        }
        arrayReference.position.traverse(this, scope);
        this.scribe.printNextToken(TerminalTokens.TokenNameRBRACKET,
                                   this.preferences.insert_space_before_closing_bracket_in_array_reference);
    ...
    public boolean visit(AssertStatement assertStatement, BlockScope scope) {
        ...
        if (assertStatement.exceptionArgument != null) {
            this.scribe
                    .printNextToken(TerminalTokens.TokenNameCOLON, this.preferences.insert_space_before_colon_in_assert);
    ...
    public boolean visit(Assignment assignment, BlockScope scope) {
        ...
        Alignment assignmentAlignment =
                this.scribe.createAlignment(Alignment.ASSIGNMENT, this.preferences.alignment_for_assignment,
                                            Alignment.R_OUTERMOST, 1, this.scribe.scanner.currentPosition);
        this.scribe.enterAlignment(assignmentAlignment);
        boolean ok = false;
        do {
    ...
    public boolean visit(Block block, BlockScope scope) {
        formatBlock(block, scope, this.preferences.brace_position_for_block,
                    this.preferences.insert_space_before_opening_brace_in_block);
        return false;
    }
    ...
    public boolean visit(CaseStatement caseStatement, BlockScope scope) {
        if (caseStatement.constantExpression == null) {
            ...
            this.scribe.printNextToken(TerminalTokens.TokenNameCOLON,
                                       this.preferences.insert_space_before_colon_in_default);
        } else {
    ...
    public boolean visit(CastExpression castExpression, BlockScope scope) {
        ...
        this.scribe.printNextToken(TerminalTokens.TokenNameRPAREN,
                                   this.preferences.insert_space_before_closing_paren_in_cast);
    ...
    public boolean visit(CompoundAssignment compoundAssignment, BlockScope scope) {
      ...
      /* Print the operator */
        ...
        Alignment assignmentAlignment =
                this.scribe.createAlignment(Alignment.COMPOUND_ASSIGNMENT, this.preferences.alignment_for_assignment,
                                            Alignment.R_OUTERMOST, 1, this.scribe.scanner.currentPosition);
        this.scribe.enterAlignment(assignmentAlignment);
        boolean ok = false;
        do {
    ...
    public boolean visit(ConditionalExpression conditionalExpression, BlockScope scope) {
        ...
        Alignment conditionalExpressionAlignment =
                this.scribe.createAlignment(Alignment.CONDITIONAL_EXPRESSION,
                                            this.preferences.alignment_for_conditional_expression, 2, this.scribe.scanner.currentPosition);
        ...
        do {
            try {
                ...
                this.scribe.printNextToken(TerminalTokens.TokenNameQUESTION,
                                           this.preferences.insert_space_before_question_in_conditional);
                ...
                this.scribe.printNextToken(TerminalTokens.TokenNameCOLON,
                                           this.preferences.insert_space_before_colon_in_conditional);
    ...
    public boolean visit(ConstructorDeclaration constructorDeclaration, ClassScope scope) {
        ...
        if (constructorDeclaration.ignoreFurtherInvestigation) {
            ...
            this.scribe.scanner.resetTo(constructorDeclaration.declarationSourceEnd + 1,
                                        this.scribe.scannerEndPosition - 1);
            this.scribe.printComment(CodeFormatter.K_UNKNOWN, Scribe.BASIC_TRAILING_COMMENT);
      ...
      /* Print comments to get proper line number */
        ...
        int line = this.scribe.line;
        this.scribe
                .printModifiers(constructorDeclaration.annotations, this, ICodeFormatterConstants.ANNOTATION_ON_METHOD);
        if (this.scribe.line > line) {
            // annotations introduced new line, but this is not a line wrapping
            // see 158267
            line = this.scribe.line;
      ...
      /* Print the method name */
        ...
        formatThrowsClause(constructorDeclaration,
        ...
        if (!constructorDeclaration.isNative() && !constructorDeclaration.isAbstract()) {
         /* Method body */
            ...
            formatOpeningBrace(constructor_declaration_brace,
                               this.preferences.insert_space_before_opening_brace_in_constructor_declaration);
            ...
            if (constructorDeclaration.constructorCall != null
                && !constructorDeclaration.constructorCall.isImplicitSuper()) {
                this.scribe.printNewLine();
    ...
    public boolean visit(DoStatement doStatement, BlockScope scope) {
        ...
        this.scribe.printNextToken(TerminalTokens.TokenNamewhile,
                                   this.preferences.insert_space_after_closing_brace_in_block);
        this.scribe.printNextToken(TerminalTokens.TokenNameLPAREN,
                                   this.preferences.insert_space_before_opening_paren_in_while);
        ...
        this.scribe.printNextToken(TerminalTokens.TokenNameRPAREN,
                                   this.preferences.insert_space_before_closing_paren_in_while);
        this.scribe.printNextToken(TerminalTokens.TokenNameSEMICOLON, this.preferences.insert_space_before_semicolon);
        this.scribe.printComment(CodeFormatter.K_UNKNOWN, Scribe.BASIC_TRAILING_COMMENT);
        return false;
    }
    ...
    public boolean visit(FieldDeclaration enumConstant, MethodScope scope) {
      /* Print comments to get proper line number */
        ...
        this.scribe.printNextToken(TerminalTokens.TokenNameIdentifier, false);
        formatEnumConstantArguments(enumConstant, this.preferences.insert_space_before_opening_paren_in_enum_constant,
        ...
        if (initialization instanceof QualifiedAllocationExpression) {
         ...
         /* Type body */
            ...
            formatTypeOpeningBraceForEnumConstant(enum_constant_brace,
                                                  this.preferences.insert_space_before_opening_brace_in_enum_constant, typeDeclaration);
    ...
    public boolean visit(ExplicitConstructorCall explicitConstructor, BlockScope scope) {
        ...
        if (arguments != null) {
            ...
            int argumentLength = arguments.length;
            Alignment argumentsAlignment =
                    this.scribe.createAlignment(Alignment.EXPLICIT_CONSTRUCTOR_CALL,
                                                this.preferences.alignment_for_arguments_in_explicit_constructor_call, argumentLength,
                                                this.scribe.scanner.currentPosition);
            this.scribe.enterAlignment(argumentsAlignment);
            boolean ok = false;
            do {
                try {
                    for (int i = 0; i < argumentLength; i++) {
                        if (i > 0) {
                            this.scribe.printNextToken(TerminalTokens.TokenNameCOMMA,
                                                       this.preferences.insert_space_before_comma_in_explicit_constructor_call_arguments);
                            this.scribe.printComment(CodeFormatter.K_UNKNOWN, Scribe.BASIC_TRAILING_COMMENT);
                        }
                        this.scribe.alignFragment(argumentsAlignment, i);
    ...
    public boolean visit(ForeachStatement forStatement, BlockScope scope) {
        ...
        final int line = this.scribe.line;
        this.scribe.printNextToken(TerminalTokens.TokenNameLPAREN,
                                   this.preferences.insert_space_before_opening_paren_in_for);
        ...
        this.scribe.printNextToken(TerminalTokens.TokenNameRPAREN,
                                   this.preferences.insert_space_before_closing_paren_in_for);
    ...
    public boolean visit(ForStatement forStatement, BlockScope scope) {
        ...
        if (initializations != null) {
            ...
            for (int i = 0; i < length; i++) {
                if (initializations[i] instanceof LocalDeclaration) {
                    formatLocalDeclaration((LocalDeclaration)initializations[i], scope,
        ...
        this.scribe.printNextToken(TerminalTokens.TokenNameSEMICOLON,
                                   this.preferences.insert_space_before_semicolon_in_for);
        ...
        if (increments != null) {
            ...
            for (int i = 0, length = increments.length; i < length; i++) {
                ...
                if (i != length - 1) {
                    this.scribe.printNextToken(TerminalTokens.TokenNameCOMMA,
                                               this.preferences.insert_space_before_comma_in_for_increments);
    ...
    public boolean visit(IfStatement ifStatement, BlockScope scope) {
        ...
        final int line = this.scribe.line;
        this.scribe.printNextToken(TerminalTokens.TokenNameLPAREN,
                                   this.preferences.insert_space_before_opening_paren_in_if);
        if (this.preferences.insert_space_after_opening_paren_in_if) {
            this.scribe.space();
        }
        ifStatement.condition.traverse(this, scope);
        this.scribe.printNextToken(TerminalTokens.TokenNameRPAREN,
                                   this.preferences.insert_space_before_closing_paren_in_if);
        ...
        if (thenStatement != null) {
            if (thenStatement instanceof Block) {
                ...
                if (isGuardClause((Block)thenStatement) && elseStatement == null
                ...
                */
                ...
                Alignment compactIfAlignment =
                        this.scribe.createAlignment(Alignment.COMPACT_IF, this.preferences.alignment_for_compact_if,
                                                    Alignment.R_OUTERMOST, 1, this.scribe.scanner.currentPosition, 1, false);
        ...
        if (elseStatement != null) {
            if (thenStatementIsBlock) {
                this.scribe.printNextToken(TerminalTokens.TokenNameelse,
                                           this.preferences.insert_space_after_closing_brace_in_block,
    ...
    public boolean visit(LabeledStatement labeledStatement, BlockScope scope) {
        ...
        this.scribe.printNextToken(TerminalTokens.TokenNameIdentifier);
        this.scribe.printNextToken(TerminalTokens.TokenNameCOLON,
                                   this.preferences.insert_space_before_colon_in_labeled_statement);
    ...
    public boolean visit(LocalDeclaration localDeclaration, BlockScope scope) {
        formatLocalDeclaration(localDeclaration, scope,
    ...
    public boolean visit(MessageSend messageSend, BlockScope scope) {
        ...
        if (builder.size() >= 3 && numberOfParens == 0) {
            ...
            if (!messageSend.receiver.isImplicitThis()) {
                ...
                messageAlignment =
                        this.scribe.createAlignment(Alignment.MESSAGE_SEND, alignmentMode, 1,
                                                    this.scribe.scanner.currentPosition);
    ...
    public boolean visit(MethodDeclaration methodDeclaration, ClassScope scope) {
      ...
      /* Print comments to get proper line number */
        ...
        // Create alignment
        Alignment methodDeclAlignment =
                this.scribe.createAlignment(Alignment.METHOD_DECLARATION, this.preferences.alignment_for_method_declaration,
                                            Alignment.R_INNERMOST, 3, this.scribe.scanner.currentPosition);
        ...
        do {
            ...
            /* Print the method name */
                ...
                // Format arguments
                formatMethodArguments(methodDeclaration,
            ...
            /* Check for extra dimensions */
                ...
                // Format throws
                formatThrowsClause(methodDeclaration,
        ...
        if (!methodDeclaration.isNative() && !methodDeclaration.isAbstract()
         ...
         /* Method body */
            ...
            formatOpeningBrace(method_declaration_brace,
                               this.preferences.insert_space_before_opening_brace_in_method_declaration);
            final int numberOfBlankLinesAtBeginningOfMethodBody = this.preferences.blank_lines_at_beginning_of_method_body;
            if (numberOfBlankLinesAtBeginningOfMethodBody > 0) {
                this.scribe.printEmptyLines(numberOfBlankLinesAtBeginningOfMethodBody);
            }
    ...
    public boolean visit(NormalAnnotation annotation, BlockScope scope) {
        ...
        if (memberValuePairs != null) {
            ...
            Alignment annotationAlignment =
                    this.scribe.createAlignment(Alignment.ANNOTATION_MEMBERS_VALUE_PAIRS,
                                                this.preferences.alignment_for_arguments_in_annotation, length,
                                                this.scribe.scanner.currentPosition);
            ...
            do {
                try {
                    for (int i = 0; i < length; i++) {
                        if (i > 0) {
                            this.scribe.printNextToken(TerminalTokens.TokenNameCOMMA,
                                                       this.preferences.insert_space_before_comma_in_annotation);
                            this.scribe.printComment(CodeFormatter.K_UNKNOWN, Scribe.BASIC_TRAILING_COMMENT);
                        }
        ...
        this.scribe.printNextToken(TerminalTokens.TokenNameRPAREN,
                                   this.preferences.insert_space_before_closing_paren_in_annotation);
        return false;
    }
    ...
    public boolean visit(ParameterizedQualifiedTypeReference parameterizedQualifiedTypeReference, BlockScope scope) {
        final int numberOfParens =
                (parameterizedQualifiedTypeReference.bits & ASTNode.ParenthesizedMASK) >> ASTNode.ParenthesizedSHIFT;
        if (numberOfParens > 0) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (typeArgument != null) {
                ...
                if (typeArgumentLength > 0) {
                    this.scribe.printNextToken(TerminalTokens.TokenNameLESS,
                                               this.preferences.insert_space_before_opening_angle_bracket_in_parameterized_type_reference);
                    ...
                    for (int j = 0; j < typeArgumentLength - 1; j++) {
                        ...
                        this.scribe.printNextToken(TerminalTokens.TokenNameCOMMA,
                                                   this.preferences.insert_space_before_comma_in_parameterized_type_reference);
    ...
    public boolean visit(ParameterizedSingleTypeReference parameterizedSingleTypeReference, BlockScope scope) {
        final int numberOfParens =
                (parameterizedSingleTypeReference.bits & ASTNode.ParenthesizedMASK) >> ASTNode.ParenthesizedSHIFT;
        if (numberOfParens > 0) {
        ...
        if (typeArgumentsLength > 0) {
            ...
            if (isClosingGenericToken()) {
                this.scribe.printNextToken(CLOSING_GENERICS_EXPECTEDTOKENS,
                                           this.preferences.insert_space_before_closing_angle_bracket_in_parameterized_type_reference);
            }
        } else {
            this.scribe.printNextToken(TerminalTokens.TokenNameLESS,
                                       this.preferences.insert_space_before_opening_angle_bracket_in_parameterized_type_reference);
    ...
    public boolean visit(PostfixExpression postfixExpression, BlockScope scope) {
        ...
        int operator =
                postfixExpression.operator == OperatorIds.PLUS ? TerminalTokens.TokenNamePLUS_PLUS
                                                               : TerminalTokens.TokenNameMINUS_MINUS;
    ...
    public boolean visit(PrefixExpression prefixExpression, BlockScope scope) {
        ...
        int operator =
                prefixExpression.operator == OperatorIds.PLUS ? TerminalTokens.TokenNamePLUS_PLUS
                                                              : TerminalTokens.TokenNameMINUS_MINUS;
    ...
    public boolean visit(QualifiedAllocationExpression qualifiedAllocationExpression, BlockScope scope) {
        ...
        final int numberOfParens =
                (qualifiedAllocationExpression.bits & ASTNode.ParenthesizedMASK) >> ASTNode.ParenthesizedSHIFT;
        if (numberOfParens > 0) {
        ...
        if (arguments != null) {
            ...
            Alignment argumentsAlignment =
                    this.scribe.createAlignment(Alignment.ALLOCATION,
                                                this.preferences.alignment_for_arguments_in_qualified_allocation_expression, argumentLength,
                                                this.scribe.scanner.currentPosition);
            this.scribe.enterAlignment(argumentsAlignment);
            boolean ok = false;
            do {
    ...
    public boolean visit(QualifiedNameReference qualifiedNameReference, BlockScope scope) {
        ...
        final int numberOfParens =
                (qualifiedNameReference.bits & ASTNode.ParenthesizedMASK) >> ASTNode.ParenthesizedSHIFT;
        if (numberOfParens > 0) {
    ...
    public boolean visit(QualifiedSuperReference qualifiedSuperReference, BlockScope scope) {
        ...
        final int numberOfParens =
                (qualifiedSuperReference.bits & ASTNode.ParenthesizedMASK) >> ASTNode.ParenthesizedSHIFT;
        if (numberOfParens > 0) {
    ...
    public boolean visit(QualifiedThisReference qualifiedThisReference, BlockScope scope) {
        ...
        final int numberOfParens =
                (qualifiedThisReference.bits & ASTNode.ParenthesizedMASK) >> ASTNode.ParenthesizedSHIFT;
        if (numberOfParens > 0) {
    ...
    public boolean visit(QualifiedTypeReference qualifiedTypeReference, BlockScope scope) {
        ...
        final int numberOfParens =
                (qualifiedTypeReference.bits & ASTNode.ParenthesizedMASK) >> ASTNode.ParenthesizedSHIFT;
        if (numberOfParens > 0) {
    ...
    public boolean visit(StringLiteralConcatenation stringLiteral, BlockScope scope) {
        ...
        Alignment binaryExpressionAlignment =
                this.scribe.createAlignment(Alignment.STRING_CONCATENATION, this.preferences.alignment_for_binary_expression,
                                            Alignment.R_OUTERMOST, fragmentsSize, this.scribe.scanner.currentPosition);
        this.scribe.enterAlignment(binaryExpressionAlignment);
        boolean ok = false;
        do {
            try {
                for (int i = 0; i < fragmentsSize - 1; i++) {
                    ...
                    this.scribe.alignFragment(binaryExpressionAlignment, i);
                    this.scribe.printNextToken(TerminalTokens.TokenNamePLUS,
    ...
    public boolean visit(SwitchStatement switchStatement, BlockScope scope) {
        ...
        this.scribe.printNextToken(TerminalTokens.TokenNameLPAREN,
                                   this.preferences.insert_space_before_opening_paren_in_switch);
            ...
            for (int i = 0; i < statementsLength; i++) {
                ...
                if (statement instanceof CaseStatement) {
                    ...
                    String bracePosition =
                            wasACase ? this.preferences.brace_position_for_block_in_case
                                     : this.preferences.brace_position_for_block;
                    formatBlock((Block)statement, scope, bracePosition,
                                this.preferences.insert_space_before_opening_brace_in_block);
                    wasACase = false;
                    wasABreak = false;
                } else {
    ...
    public boolean visit(SynchronizedStatement synchronizedStatement, BlockScope scope) {
        ...
        this.scribe.printNextToken(TerminalTokens.TokenNameLPAREN,
                                   this.preferences.insert_space_before_opening_paren_in_synchronized);
        ...
        this.scribe.printNextToken(TerminalTokens.TokenNameRPAREN,
                                   this.preferences.insert_space_before_closing_paren_in_synchronized);
    ...
    public boolean visit(TryStatement tryStatement, BlockScope scope) {
        ...
        formatTryResources(tryStatement, this.preferences.insert_space_before_opening_paren_in_try,
        ...
        if (tryStatement.catchArguments != null) {
            for (int i = 0, max = tryStatement.catchBlocks.length; i < max; i++) {
                ...
                this.scribe.printNextToken(TerminalTokens.TokenNamecatch,
                                           this.preferences.insert_space_after_closing_brace_in_block);
                final int line = this.scribe.line;
                this.scribe.printNextToken(TerminalTokens.TokenNameLPAREN,
                                           this.preferences.insert_space_before_opening_paren_in_catch);
                ...
                this.scribe.printNextToken(TerminalTokens.TokenNameRPAREN,
                                           this.preferences.insert_space_before_closing_paren_in_catch);
        ...
        if (tryStatement.finallyBlock != null) {
            ...
            this.scribe.printNextToken(TerminalTokens.TokenNamefinally,
                                       this.preferences.insert_space_after_closing_brace_in_block);
    ...
    private void formatMultiCatchArguments(Argument argument, boolean spaceBeforePipe, boolean spaceAfterPipe,
                                           int multiCatchAlignment, BlockScope scope) {
        ...
        if (length > 0) {
            Alignment argumentsAlignment =
                    this.scribe.createAlignment(Alignment.MULTI_CATCH, multiCatchAlignment, length,
                                                this.scribe.scanner.currentPosition);
            this.scribe.enterAlignment(argumentsAlignment);
            boolean ok = false;
            do {
    ...
    public boolean visit(TypeParameter typeParameter, BlockScope scope) {
        ...
        if (bounds != null) {
            this.scribe.printNextToken(TerminalTokens.TokenNameAND,
                                       this.preferences.insert_space_before_and_in_type_parameter);
    ...
    public boolean visit(UnaryExpression unaryExpression, BlockScope scope) {
      ...
      /* Print the operator */
        ...
        if (expression instanceof PrefixExpression) {
            ...
            final int numberOfParensForExpression =
                    (prefixExpression.bits & ASTNode.ParenthesizedMASK) >> ASTNode.ParenthesizedSHIFT;
            ...
            final int numberOfParensForExpression =
                    (unaryExpression2.bits & ASTNode.ParenthesizedMASK) >> ASTNode.ParenthesizedSHIFT;
            if (numberOfParensForExpression == 0) {
    ...
    public boolean visit(Wildcard wildcard, BlockScope scope) {
        this.scribe.printNextToken(TerminalTokens.TokenNameQUESTION,
                                   this.preferences.insert_space_before_question_in_wilcard);
