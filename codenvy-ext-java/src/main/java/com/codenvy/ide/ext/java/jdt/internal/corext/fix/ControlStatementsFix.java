...
import com.codenvy.ide.ext.java.jdt.core.dom.ChildPropertyDescriptor;
...
public class ControlStatementsFix extends CompilationUnitRewriteOperationsFix {
    ...
    private final static class ControlStatementFinder extends GenericVisitor {
        ...
        public ControlStatementFinder(boolean findControlStatementsWithoutBlock, boolean removeUnnecessaryBlocks,
    ...
    static class RemoveBlockOperation extends CompilationUnitRewriteOperation {
        ...
        public static boolean satisfiesCleanUpPrecondition(Statement controlStatement,
                                                           ChildPropertyDescriptor childDescriptor, boolean onlyReturnAndThrows) {
            return satisfiesPrecondition(controlStatement, childDescriptor, onlyReturnAndThrows, true);
        }

        public static boolean satisfiesQuickAssistPrecondition(Statement controlStatement,
        ...
        private static boolean satisfiesPrecondition(Statement controlStatement, ChildPropertyDescriptor childDescriptor,
                                                     boolean onlyReturnAndThrows, boolean cleanUpCheck) {
                ...
                while (true) {
                    ...
                    if (parent instanceof IfStatement) {
                        ...
                        if (body == currentChild &&
                            ((IfStatement)parent).getElseStatement() != null)//->currentChild is an unblocked then part
                            return false;
    ...
    public static ControlStatementsFix[] createRemoveBlockFix(CompilationUnit compilationUnit, ASTNode node,
        ...
        if (statement instanceof IfStatement) {
                ...
                if (RemoveBlockOperation.satisfiesQuickAssistPrecondition(item, IfStatement.THEN_STATEMENT_PROPERTY)) {
                    ...
                    if (item == statement)
                        result.add(new ControlStatementsFix(FixMessages.INSTANCE
                                                                       .ControlStatementsFix_removeIfBlock_proposalDescription(),
                                                            compilationUnit,
            ...
            if (RemoveBlockOperation.satisfiesQuickAssistPrecondition(item, IfStatement.ELSE_STATEMENT_PROPERTY)) {
                ...
                if (item == statement)
                    result.add(new ControlStatementsFix(FixMessages.INSTANCE
                                                                   .ControlStatementsFix_removeElseBlock_proposalDescription(),
                                                        compilationUnit,
                                                        new CompilationUnitRewriteOperation[]{op}, document));
            }
            ...
            if (removeAllList.size() > 1) {
                ...
                result.add(new ControlStatementsFix(FixMessages.INSTANCE
                                                               .ControlStatementsFix_removeIfElseBlock_proposalDescription(),
    ...
    public static ICleanUpFix createCleanUp(CompilationUnit compilationUnit, boolean convertSingleStatementToBlock,
        ...
        ControlStatementFinder finder =
                new ControlStatementFinder(convertSingleStatementToBlock, removeUnnecessaryBlock,
                                           removeUnnecessaryBlockContainingReturnOrThrow, operations);
