...
import com.codenvy.ide.legacy.client.text.AbstractDocument;
import com.codenvy.ide.legacy.client.text.ConfigurableLineTracker;
import com.codenvy.ide.legacy.client.text.CopyOnWriteTextStore;
import com.codenvy.ide.legacy.client.text.GapTextStore;

/**
 * Default document implementation. Uses a {@link com.codenvy.ide.legacy.client.text.store.DocumentTextStore} as text store.
 * <p>
 ...
 * </p>
 * <p>
 * See {@link com.codenvy.ide.legacy.client.text.GapTextStore} and <code>TreeLineTracker</code> for algorithmic behavior of the used document structures.
 * </p>
 */
