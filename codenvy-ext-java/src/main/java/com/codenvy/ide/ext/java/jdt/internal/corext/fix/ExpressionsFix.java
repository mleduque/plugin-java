...
public class ExpressionsFix extends CompilationUnitRewriteOperationsFix {
    ...
    private static class AddParenthesisOperation extends CompilationUnitRewriteOperation {
        ...
        public void rewriteAST(CompilationUnitRewrite cuRewrite) throws CoreException {
            TextEditGroup group =
                    createTextEditGroup(FixMessages.INSTANCE.ExpressionsFix_addParanoiacParentheses_description(), cuRewrite);
    ...
    private static class RemoveParenthesisOperation extends CompilationUnitRewriteOperation {
        ...
        public void rewriteAST(CompilationUnitRewrite cuRewrite) throws CoreException {
            TextEditGroup group =
                    createTextEditGroup(FixMessages.INSTANCE.ExpressionsFix_removeUnnecessaryParentheses_description(),
                                        cuRewrite);
    ...
    public static ExpressionsFix createAddParanoidalParenthesisFix(CompilationUnit compilationUnit,
                                                                   ASTNode[] coveredNodes, Document document) {
    ...
    public static ICleanUpFix createCleanUp(CompilationUnit compilationUnit, boolean addParanoicParentesis,
                                            boolean removeUnnecessaryParenthesis, Document document) {
